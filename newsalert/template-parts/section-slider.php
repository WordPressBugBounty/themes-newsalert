	...
	<div class="dt-container-md">
		<div class="dt-row dt-g-4">  
			...
			<?php if($newsmunch_hs_slider_mdl=='1'): ?>
				<div class="dt-col-xl-<?php if($newsmunch_hs_slider_right==''): esc_attr_e('8 dt-col-lg-8','newsalert'); else: esc_attr_e('3 dt-col-md-6','newsalert'); endif; ?>">
					<?php do_action('newsalert_site_slider_right'); ?>
				</div>
			<?php endif; ?>
			
			<?php if($newsmunch_hs_slider_left=='1'): ?>
				<div class="dt-col-xl-<?php if($newsmunch_hs_slider_mdl =='' && $newsmunch_hs_slider_right ==''): esc_attr_e('12','newsalert'); elseif($newsmunch_hs_slider_mdl =='' || $newsmunch_hs_slider_right ==''):  esc_attr_e('9','newsalert'); else: esc_attr_e('6','newsalert'); endif; ?>">
					<?php do_action('newsmunch_site_slider_main');?>
				</div>
			<?php endif; ?>
			
			<?php if($newsmunch_hs_slider_right=='1'): ?>
				<div class="dt-col-xl-<?php if($newsmunch_hs_slider_left==''): esc_attr_e('4 dt-col-lg-4','newsalert'); else: esc_attr_e('3 dt-col-md-6','newsalert'); endif; ?>">
